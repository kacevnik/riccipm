        ...
        changeCategory = function(){
            ...
            if ($('#jao').length === 0) {
                ...
                if($('.wpmf-attachments-wrapper #jao').length === 0){
                    $('.media-frame .media-frame-menu .media-menu:visible').append(menu_left);
                }
                
                if($('.media-menu:visible').find('#jao').length > 0){
                    $('.media-menu:visible').find('#jao').jaofiletree({
                        onclick: function (elem, type, file) {}
                    });
                }
                
                if($('.wpmf-attachments-wrapper:visible').find('#jao').length > 0){
            ...
            if(page !== 'table') {     
                ...
                if($('[id^="__wp-uploader-id-"]:visible #jao').length > 0){
